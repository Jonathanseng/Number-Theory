def primitive_root_mod_every_power_of_odd_prime(p):
  """
  Finds a primitive root modulo every power of p.

  Args:
    p: The odd prime.

  Returns:
    A list of all primitive roots modulo every power of p.
  """
  ...
  # Find all primitive roots modulo every power of p.
  primitive_roots_mod_powers_of_p = []
  for i in range(1, p + 1):
    primitive_roots_mod_powers_of_p.append(technical_lemma_2(p ** i))

  return primitive_roots_mod_powers_of_p
